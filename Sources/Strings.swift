...
enum Strings {
    ...
    static let connect = japanese ? "Claude Code に接続" : "Connect to Claude Code"
    static let connectFailed =
        japanese ? "Claude Code の設定ファイルを書き換えられませんでした" : "Could not update Claude Code's settings file"
